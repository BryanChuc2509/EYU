    ...
    <div class="main__wrapper">
        ...
        <main class="main">
            <div class="main__contenedor__items">
                ...
                <button type="button" class="main__items">Públicas</button>
                <button type="button" class="main__items">Privadas</button>
            </div>
            <div class="container">
                            ...
                            <li class="splide__slide">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Some quick example text to build on the card title and make
                                            up the bulk of the card's content. Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt, ipsum praesentium. Obcaecati et possimus saepe natus asperiores, aut a similique quo ratione voluptas incidunt veniam minima unde enim, voluptatibus sed!</p>
                                        <a href="#" class="btn btn-outline-primary">Ver más</a>
                            ...
                            <li class="splide__slide">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Some quick example text to build on the card title and make
                                            up the bulk of the card's content. Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea, quo nisi explicabo accusamus maxime numquam repellendus fugiat dolor ipsa iusto, earum iste repellat nam odit temporibus quisquam ullam reprehenderit hic!</p>
                                        <a href="#" class="btn btn-outline-primary">Ver más</a>
                                        <a href="#" class="btn btn-outline-success">Guardar</a>
